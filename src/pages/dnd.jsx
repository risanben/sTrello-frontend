...
export function Dnd() {
    ...
    return (
        <section className='homo-logo' style={{display:"flex", width:"min-content", margin:"auto", marginTop:"60px", marginLeft:"700px"}}>
            <ImTrello className='trello-logo' style={{fontSize:"150px", color:"rgb(0, 101, 255)", marginTop:"6px", marginInlineEnd:"30px"}} />
            <section className="logo" style={{fontSize:"150px", fontFamily:"secular", fontWeight:"600", letterSpacing:"1px"}}>
                sTrello
            </section>
        </section>
    )
